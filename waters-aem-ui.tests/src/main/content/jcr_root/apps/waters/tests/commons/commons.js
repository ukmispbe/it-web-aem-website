;(function(h, $) {
    ...
    c.rootPage = "/content/waters/language-masters/en";
    // the template defined in the test content package
    c.template = "/conf/waters/settings/wcm/templates/application-notes-page";
    // relative path from page node to the root layout container
    c.relParentCompPath = "/jcr:content/root/responsivegrid/";
    //text component
    c.rtText = "waters/components/content/text";


    // the path to the policies
    c.policyPath = "/conf/waters/settings/wcm/policies/waters/components/content";
    // the policy assignment path
   // c.policyAssignmentPath = "/conf/waters/settings/wcm/templates/hero-page/policies/jcr:content/root/responsivegrid/weretail/components/content";
    ...
    c.createPage = function (templatePath, parentPath, pageName, dynParName, done, testPageRT) {
        ...
        jQuery.ajax({
            ...
            data: {
                ...
                "./jcr:title": pageName,
                "pageName": pageName,
                "./sling:resourceType": testPageRT || "waters/components/structure/page"
            }
        })
    ...
    */
    c.tcExecuteBeforeTest = new TestCase("Common Set up")
        ...
        .navigateTo("/content/waters/language-masters/en.html")
