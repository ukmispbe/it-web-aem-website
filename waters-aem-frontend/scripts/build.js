...
const clientlibPath = 'waters-aem-ui.apps/src/main/content/jcr_root/apps/waters/clientlibs/clientlib-site';
...
compiler.run((err, stats) => {
    ...
    const aemCssPath = path.resolve(__dirname, '../../', clientlibPath + '/css', 'main.css');
    const aemJsPath = path.resolve(__dirname, '../../', clientlibPath + '/js', 'main.js');
