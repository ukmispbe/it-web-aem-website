...
export const registrationConfig = {
    submitEndpoint: "https://testservices.waters.com:8443/api/waters/user/v1/registration",
    ...
    fields: [
        {
            ...
            label: "Email Address",
            description: "This will be your username.",
            emailValidationEndpoint: "https://testservices.waters.com:8443/api/waters/user/v1/validate/{email}",
            validation: {
                required: true,
                requiredMsg: "Please enter a valid email address.",
                validateFnName: "email",
...
export const troubleSigningInConfig = {
	submitEndpoint: "https://testservices.waters.com:8443/api/waters/user/v1/reset/password?email={email}",
	changePasswordEndpoint: "https://testservices.waters.com:8443/api/waters/user/v1/change/password",
...
{
    "submitEndpoint": "https://testservices.waters.com:8443/api/waters/user/v1/login",
    "siteKey": "6Ld5WMIUAAAAACZQvEc7I75aEg5AC8YUUO0W7zRG",
    "formName": "signin",
    "buttonText": "SIGN IN",
    "icons": {
