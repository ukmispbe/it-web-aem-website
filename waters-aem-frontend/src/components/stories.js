...
import { storiesOf as storiesOfHtml } from '@storybook/html';
...
import testStory from './test-component/test-component.story';

storiesOfHtml('Waters Component Library', module)
