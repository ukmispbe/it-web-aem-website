...
public class ReviewRequestedNotificationStep implements WorkflowProcess {
    ...
    public void execute(WorkItem item, WorkflowSession wfSession, MetaDataMap args) throws WorkflowException {
        ...
        if(!StringUtils.isBlank(reviewerId)){
            WorkflowUtils.sendNotification(userManager, resolver, item, reviewerId, reviewerId, TEMPLATE_PATH, emailService);
        }
