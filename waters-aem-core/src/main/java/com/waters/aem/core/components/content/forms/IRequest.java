...
@Component(value = "IRequest Form",
    description = "This is the IRequest Form component for Waters site",
...
@Model(adaptables = SlingHttpServletRequest.class,
    adapters = { IRequest.class, ComponentExporter.class },
    resourceType = IRequest.RESOURCE_TYPE,
    defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL)
@Exporter(name = ExporterConstants.SLING_MODEL_EXPORTER_NAME,
    extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class IRequest implements ComponentExporter {

    public static final String RESOURCE_TYPE = "waters/components/content/forms/irequest";
