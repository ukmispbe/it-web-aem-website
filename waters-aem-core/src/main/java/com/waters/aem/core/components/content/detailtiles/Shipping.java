...
@Component(value = "Shipping Address Details Tile",
        description = "This is the Shipping Address Details Tile component for Waters site my profile",
...
@Model(adaptables = SlingHttpServletRequest.class,
        adapters = { Shipping.class, ComponentExporter.class },
        resourceType = Shipping.RESOURCE_TYPE,
        defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL)
@Exporter(name = ExporterConstants.SLING_MODEL_EXPORTER_NAME,
        extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class Shipping implements ComponentExporter {

    public static final String RESOURCE_TYPE = "waters/components/content/detailtiles/shipping";
