...
public @interface WatersAccountServiceConfiguration {
    ...
    String userDetailsUrl() default "https://dev-www.waters.com:8443/api/waters/user/v1/details";

    @AttributeDefinition(name = "Sold To Details API Url", description = "Url for Sold To Details API")
    String soldToDetailsUrl() default "https://dev-www.waters.com:8443/api/waters/user/v1/retrievesoldto";

    @AttributeDefinition(name = "Update Password API Url", description = "Url for update password API")
    String updatePwUrl() default "https://dev-www.waters.com:8443/api/waters/user/v1/update/password";

    @AttributeDefinition(name = "Update Profile API Url", description = "Url for update profile API")
    String updateProfileUrl() default "https://dev-www.waters.com:8443/api/waters/user/v1/update/profile";

    @AttributeDefinition(name = "Sign In Endpoint", description = "The Endpoint for the Sign In API")
    String signInEndpoint() default "https://dev-www.waters.com:8443/api/waters/user/v1/login";

    @AttributeDefinition(name = "Sign Out Endpoint", description = "The Endpoint for the Sign Out API")
    String signOutEndpoint() default "https://dev-www.waters.com:8443/api/waters/user/v1/logout";

    @AttributeDefinition(name = "Choose Account Endpoint", description = "The Endpoint for the Choose Account API")
    String chooseAccountEndpoint() default "https://dev-www.waters.com:8443/api/waters/user/v1/switchaccount";

    @AttributeDefinition(name = "Order Details API Url", description = "Url for Order Details API")
    String orderDetailsUrl() default "https://dev-www.waters.com:8443/api/waters/order/v1/details";

    @AttributeDefinition(name = "Order List API Url", description = "Url for Order List API")
    String orderListUrl() default "https://dev-www.waters.com:8443/api/waters/order/v1/list";
}
