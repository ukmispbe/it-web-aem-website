...
public @interface WatersCommerceServiceConfiguration {
    ...
    String skuAvailabilityUrl() default "https://wwwdt1.waters.com/api/waters/product/v1/availability/{partnumber}/{countryCode}";

    @AttributeDefinition(name = "Customer Price Endpoint", description = "URL for the Sku Customer Price endpoint")
    String skuCustomerPriceUrl() default "https://wwwdt1.waters.com/api/waters/product/v1/customerprice/{partnumber}/{countryCode}";
