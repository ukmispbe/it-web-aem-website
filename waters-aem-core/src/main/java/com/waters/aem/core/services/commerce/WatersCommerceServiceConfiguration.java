...
public @interface WatersCommerceServiceConfiguration {
    ...
    String skuAvailabilityUrl() default "https://devservices.waters.com:8443/api/waters/product/v1/availability/{partnumber}/{countryCode}";
    ...
    String addToCartUrl() default "https://devservices.waters.com:8443/api/waters/product/v1/addtocart/{partnumber}/{quantity}";
