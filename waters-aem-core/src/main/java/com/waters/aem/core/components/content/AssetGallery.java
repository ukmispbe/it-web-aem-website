...
@Model(adaptables = SlingHttpServletRequest.class,
    adapters = { AssetGallery.class, ComponentExporter.class },
    resourceType = AssetGallery.RESOURCE_TYPE,
    defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL)
@Exporter(name = ExporterConstants.SLING_MODEL_EXPORTER_NAME,
    extensions = ExporterConstants.SLING_MODEL_EXTENSION)
@SuppressWarnings("squid:S3252")
public final class AssetGallery implements ComponentExporter {

    public static final String RESOURCE_TYPE = "waters/components/content/assetgallery";
    ...
    public String getVideoJson()  throws JsonProcessingException {
