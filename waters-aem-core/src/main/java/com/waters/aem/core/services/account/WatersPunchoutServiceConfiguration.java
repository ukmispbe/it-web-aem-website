...
public @interface WatersPunchoutServiceConfiguration {
    ...
    @AttributeDefinition(name = "Punchout signin Url", description = "Url for Logging a Punchout user")
    String puchOutSignInUrl() default "https://test-www.waters.com:8443/api/waters/punchout/v1/login";
}