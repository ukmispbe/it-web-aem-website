...
public @interface WatersPunchoutServiceConfiguration {
    ...
    String setupUrl() default "https://test-www.waters.com:8443/api/waters/punchout/v1/setup";

    @AttributeDefinition(name = "Punchout Login Url", description = "Url for Logging a Punchout user")
    String punchoutLogin() default "https://test-www.waters.com:8443/api/waters/punchout/v1/login";
}